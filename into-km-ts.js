...
console.log("katherine".includes("e"))

// Write the code that will log the character at the first index of the string.

console.log("Katherine".charAt(0))

// Write the code that will log the string in all uppercase letters.

console.log("katherine".toUpperCase())
...
// / let school="LEARN" -- Be sure to declare variable before inserting it in to a function--
