...
let listTwo = groceryList.slice(0,2)
listTwo.push("beans")
console.log(listTwo)
...
let teamone = ["Jack", "Dustin", "Jonathan"]
let teamtwo = ["Victor", "Kathy", "Earl"]


// Write the code that sorts the names in alphabetical order.

console.log(teamone.sort(),teamtwo.sort())
